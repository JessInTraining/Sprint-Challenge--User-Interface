...
The language you use to create the skeleton of your webpage.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

One stays on the same line and uses up all the available space and the other starts on a new line when it runs out of space.
...
You are able to edit content without changing the original content and can save that copy and posibbly merge with the original.
